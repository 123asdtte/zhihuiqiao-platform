  ...
  <div class="resource-list-page zh-page">
    ...
    <div class="filter-bar">
      <div class="filter-group">
        ...
        <el-radio-group v-model="searchForm.tradeMode" @change="handleSearch">
      ...
      >
        ...
        <div class="resource-info">
          <div class="resource-meta-top">
            ...
            <el-tag v-if="item.tradeMode === 'transfer'" type="warning" size="small">转让</el-tag>
            <el-tag v-else type="success" size="small">借用</el-tag>
          ...
          <div class="resource-footer">
            <span class="resource-price">
              <!-- 转让模式显示期望价格 -->
              <template v-if="item.tradeMode === 'transfer'">
                <span v-if="item.expectPrice > 0" class="paid">¥{{ item.expectPrice }}</span>
...
async function loadResourceList() {
  ...
  try {
    const res: any = await getResourceList({
      ...
      tradeMode: searchForm.tradeMode
    })
